                    ...
                    <div className="p-6">
                        <div className="flex items-center space-x-4">
                            <div className="w-12 h-12 rounded-full bg-slate-400 flex items-center justify-center">
                                <span className="text-2xl text-white">{name[0]?.toUpperCase() || "A"}</span>
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                  {state ? "Processing…" : "Initiate Transfer"}
                            </button>
                            <button 
                            onClick={() => navigate(-1)}
                            className="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-black text-white">Back</button>
                        </div>
                    </div>
                </div>
            </div>
